    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Join Expense Splitter today</p>
        </div>
        ...
        <div className="mt-6 grid grid-cols-3 gap-3">
          <div className="p-3 bg-gray-800/30 rounded-xl border border-gray-700/50 text-center">
            <p className="text-emerald-400 text-xs font-medium">Split Bills</p>
          </div>
          <div className="p-3 bg-gray-800/30 rounded-xl border border-gray-700/50 text-center">
            <p className="text-emerald-400 text-xs font-medium">Track Expenses</p>
          </div>
          <div className="p-3 bg-gray-800/30 rounded-xl border border-gray-700/50 text-center">
            <p className="text-emerald-400 text-xs font-medium">Settle Up</p>
          </div>
        </div>
      </div>
    </div>
